...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train and export a tiny Sudoku hard-set next-op transformer."
    )
    parser.add_argument("--dataset", type=Path, default=Path("soduku/training/hard-op-dataset.json"))
    parser.add_argument("--raw-dir", type=Path, default=Path("soduku/training/hard-op-bert"))
    parser.add_argument("--export-dir", type=Path, default=Path("soduku/models/hard-op-bert"))
...
def main() -> None:
    ...
    if not train_samples.texts or not eval_samples.texts:
        raise RuntimeError("Sudoku hard-set dataset must contain both train and eval samples.")
